        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="contact-info space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 group hover:translate-x-[10px] transition-transform duration-300">
          ...
          {/* Contact Form */}
          <form className="contact-form space-y-6 bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl p-8">
            <div>
            ...
            <div>
              <label htmlFor="service" className="block text-white mb-2 font-medium">Servicio de interés</label>
              <select
                id="service"
