...
export function Stats() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex flex-col justify-center py-24 px-4 bg-black overflow-hidden">
      ...
      {/* Nebula orbs */}
      <div className="stats-orb absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[700px] h-[220px] bg-purple-800/12 rounded-full blur-[90px] pointer-events-none" />
      <div className="stats-nebula-l absolute top-0 left-[-10%] w-[18rem] md:w-[40rem] h-[18rem] md:h-[40rem] bg-indigo-900/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="stats-nebula-r absolute bottom-0 right-[-10%] w-[16rem] md:w-[35rem] h-[16rem] md:h-[35rem] bg-violet-900/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-4">
          {STATS.map((stat, i) => (
            ...
            >
              <div
                className={`stat-number-${i} text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black bg-gradient-to-b from-white to-gray-400 bg-clip-text text-transparent mb-3 tabular-nums`}
              >
